...
const IngredientComponent = dynamic(() => import("@/components/ingredient/ingredients"), {
  loading: () => <p>Loading Ingredients...</p>, 
});
const BlogComponent = dynamic(() => import("@/components/blog/blog"), {
    ...
    <div className="flex flex-col">
      <div className="h-screen p-4  lg:p-8 md:p-8 xl:p-8 2xl:p-8">
        <div className="bg-[#e3f5fb] h-full">
              ...
              <div className="flex flex-col basis-1/3 items-center mt-6 md:m-0 lg:m-0 xl:mt-0">
                <div>
                  <Image
                    src="/assets/f2-1.png"
                    alt="bottle"
                    className="h-52 w-52 md:72 md:w-76 lg:h-72 lg:w-76 xl:h-72 xl:w-72 2xl:h-72 2xl:h-72"
                    width={300}
                    height={300}
                    priority={true}
                  />
          ...
          <div className="rounded-[50px] mt-20 md:mt-28 lg:mt-28 h-[950px] sm:h-1/4 md:h-2/6 lg:h-2/5 xl:h-96 w-[80%]  md:w-11/12 lg:w-4/5 bg-[#18414e] items-center mx-auto my-auto relative">
